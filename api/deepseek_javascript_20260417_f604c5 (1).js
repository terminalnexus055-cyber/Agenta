...
// Upgrades v3: retry+backoff, sequential calls, reduced tokens, no Groq fallback for Gemini
...
async function callGroq(systemPrompt, userPrompt, maxTokens = 1500, model = 'llama-3.3-70b-versatile', retries = 3) {
  let lastError;
...
// ─── GEMINI CALL (NO FALLBACK TO GROQ) ───
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // STEP 3: Reviewer (Groq, smaller model)
